...
public abstract class TimelineFragment extends StatusListFragment {
    ...
    public abstract MastodonAPIRequest<List<Status>> getGetTimelineRequest(String maxID, String minID, int limit, String sinceID);
    public abstract void getTimeline(String maxID, int count, boolean forceReload, Callback<CacheablePaginatedResponse<List<Status>>> callback);
    public abstract void putTimeline(List<Status> posts, boolean clear);
    ...
    protected void doLoadData(int offset, int count){
        getTimeline(offset>0 ? maxID : null, count, refreshing, new SimpleCallback<>(this){
                    @Override
    ...
    private void loadNewPosts(){
        ...
        currentRequest= getGetTimelineRequest(null, null, 20, sinceID)
    ...
    public void onGapClick(GapStatusDisplayItem.Holder item){
        ...
        dataLoading=true;
        currentRequest= getGetTimelineRequest(item.getItemID(), null, 20, null)
                .setCallback(new Callback<>(){
                    @Override
                    public void onSuccess(List<Status> result){
                        currentRequest=null;
                        ...
                        if(result.isEmpty()){
                            ...
                            if(gapStatus!=null){
                                ...
                                putTimeline(Collections.singletonList(gapStatus), false);
                            }
                        }else{
                            ...
                            for(Status s:data){
                                if(belowGap){
                                    ...
                                    belowGap=true;
                                    s.hasGapAfter=false;
                                    putTimeline(Collections.singletonList(s), false);
                                }else{
                                    gapPostIndex++;
                                }
                            }
                            ...
                            putTimeline(insertedPosts, false);
                        }
                    }
